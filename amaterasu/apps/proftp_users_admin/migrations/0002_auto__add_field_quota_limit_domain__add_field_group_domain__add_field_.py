...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quota_Limit.domain'
        db.add_column('proftp_users_admin_quota_limit', 'domain',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Domain']),
                      keep_default=False)

        # Adding field 'Group.domain'
        db.add_column('proftp_users_admin_group', 'domain',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Domain']),
                      keep_default=False)

        # Adding field 'Usuario.domain'
        db.add_column('proftp_users_admin_usuario', 'domain',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Domain']),
                      keep_default=False)

        # Adding field 'Quota_Tally.domain'
        db.add_column('proftp_users_admin_quota_tally', 'domain',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Domain']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quota_Limit.domain'
        db.delete_column('proftp_users_admin_quota_limit', 'domain_id')

        # Deleting field 'Group.domain'
        db.delete_column('proftp_users_admin_group', 'domain_id')

        # Deleting field 'Usuario.domain'
        db.delete_column('proftp_users_admin_usuario', 'domain_id')

        # Deleting field 'Quota_Tally.domain'
        db.delete_column('proftp_users_admin_quota_tally', 'domain_id')
