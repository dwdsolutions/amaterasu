...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Usuario.gid'
        db.alter_column('proftp_users_admin_usuario', 'gid', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Usuario.uid'
        db.alter_column('proftp_users_admin_usuario', 'uid', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Usuario.gid'
        db.alter_column('proftp_users_admin_usuario', 'gid', self.gf('django.db.models.fields.SmallIntegerField')())

        # Changing field 'Usuario.uid'
        db.alter_column('proftp_users_admin_usuario', 'uid', self.gf('django.db.models.fields.SmallIntegerField')())
    ...
    models = {
        ...
        'proftp_users_admin.usuario': {
            ...
            'domain': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Domain']"}),
            'gid': ('django.db.models.fields.IntegerField', [], {'default': '5500'}),
            ...
            'uid': ('django.db.models.fields.IntegerField', [], {'default': '5500'}),
