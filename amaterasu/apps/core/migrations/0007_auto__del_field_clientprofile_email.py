...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ClientProfile.email'
        db.delete_column('core_clientprofile', 'email')


    def backwards(self, orm):
        # Adding field 'ClientProfile.email'
        db.add_column('core_clientprofile', 'email',
                      self.gf('django.db.models.fields.EmailField')(default=datetime.datetime(2012, 9, 24, 0, 0), max_length=75),
                      keep_default=False)
