...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Domain.have_dns_service'
        db.add_column('core_domain', 'have_dns_service',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Domain.have_dns_service'
        db.delete_column('core_domain', 'have_dns_service')
