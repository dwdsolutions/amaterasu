...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Mailbox.domain' to match new field type.
        db.rename_column('core_mailbox', 'domain', 'domain_id')
        # Changing field 'Mailbox.domain'
        db.alter_column('core_mailbox', 'domain_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Domain']))
        # Adding index on 'Mailbox', fields ['domain']
        db.create_index('core_mailbox', ['domain_id'])


    def backwards(self, orm):
        # Removing index on 'Mailbox', fields ['domain']
        db.delete_index('core_mailbox', ['domain_id'])


        # Renaming column for 'Mailbox.domain' to match new field type.
        db.rename_column('core_mailbox', 'domain_id', 'domain')
        # Changing field 'Mailbox.domain'
        db.alter_column('core_mailbox', 'domain', self.gf('django.db.models.fields.CharField')(max_length=100))
