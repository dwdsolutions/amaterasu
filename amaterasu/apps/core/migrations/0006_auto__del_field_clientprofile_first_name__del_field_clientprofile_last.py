...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ClientProfile.first_name'
        db.delete_column('core_clientprofile', 'first_name')

        # Deleting field 'ClientProfile.last_name'
        db.delete_column('core_clientprofile', 'last_name')


    def backwards(self, orm):
        # Adding field 'ClientProfile.first_name'
        db.add_column('core_clientprofile', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=150),
                      keep_default=False)

        # Adding field 'ClientProfile.last_name'
        db.add_column('core_clientprofile', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=150),
                      keep_default=False)
